        ...
        **/
        ...
        {toMethodArrayBuffer(service.methods).map{(method: Method)=> {
          ...
          <div>
            ...
            class {method.name.charAt(0).toUpper + method.name.substring(1)}_argsSerializer extends TCommonBeanSerializer[{method.name}_args]<block>
            ...
            class {method.name.charAt(0).toUpper + method.name.substring(1)}_resultSerializer extends TCommonBeanSerializer[{method.name}_result]<block>
