...
import com.isuwang.soa.monitor.api.service.MonitorServiceAsync;
        ...
        *  @generated
        **/
        public class MonitorServiceAsyncCodec {
      ...
      public void validate(uploadQPSStat_result bean) throws TException{
            ...
            public static class uploadQPSStat<I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> extends SoaFunctionDefinition.Async<I, uploadQPSStat_args, uploadQPSStat_result>
            {
              ...
              @Override
              public CompletableFuture<uploadQPSStat_result> apply(MonitorServiceAsync iface, uploadQPSStat_args uploadQPSStat_args) throws SoaException
              {

                CompletableFuture<Void> result = (CompletableFuture<Void>) iface.uploadQPSStat(uploadQPSStat_args.qpsStats ,50000);

                return result.thenApply((Void) -> {
                  uploadQPSStat_result res = new uploadQPSStat_result();
      ...
      public void validate(uploadPlatformProcessData_result bean) throws TException{
            ...
            public static class uploadPlatformProcessData<I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> extends SoaFunctionDefinition.Async<I, uploadPlatformProcessData_args, uploadPlatformProcessData_result>
            {
              ...
              @Override
              public CompletableFuture<uploadPlatformProcessData_result> apply(MonitorServiceAsync iface, uploadPlatformProcessData_args uploadPlatformProcessData_args) throws SoaException
              {

                CompletableFuture<Void> result = (CompletableFuture<Void>) iface.uploadPlatformProcessData(uploadPlatformProcessData_args.platformProcessDatas ,50000);

                return result.thenApply((Void) -> {
                  uploadPlatformProcessData_result res = new uploadPlatformProcessData_result();
      ...
      public void validate(uploadDataSourceStat_result bean) throws TException{
            ...
            public static class uploadDataSourceStat<I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> extends SoaFunctionDefinition.Async<I, uploadDataSourceStat_args, uploadDataSourceStat_result>
            {
              ...
              @Override
              public CompletableFuture<uploadDataSourceStat_result> apply(MonitorServiceAsync iface, uploadDataSourceStat_args uploadDataSourceStat_args) throws SoaException
              {

                CompletableFuture<Void> result = (CompletableFuture<Void>) iface.uploadDataSourceStat(uploadDataSourceStat_args.dataSourceStat ,50000);

                return result.thenApply((Void) -> {
                  uploadDataSourceStat_result res = new uploadDataSourceStat_result();
        ...
        public static class getServiceMetadata<I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> extends SoaFunctionDefinition.Async<I, getServiceMetadata_args, getServiceMetadata_result> {
        ...
        public static class Processor<I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> extends SoaServiceDefinition<com.isuwang.soa.monitor.api.service.MonitorServiceAsync>
        {

          public Processor(com.isuwang.soa.monitor.api.service.MonitorServiceAsync iface, Class<com.isuwang.soa.monitor.api.service.MonitorServiceAsync> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.isuwang.soa.monitor.api.service.MonitorServiceAsync> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
