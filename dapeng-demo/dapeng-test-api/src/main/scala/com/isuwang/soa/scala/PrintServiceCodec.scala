...
import com.isuwang.soa.scala.info.serializer._;
      ...
      override def validate(bean: print_result): Unit = {
            ...
            class print extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.PrintService, print_args, print_result]("print", new Print_argsSerializer(), new Print_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.PrintService, args: print_args):print_result = {
      ...
      override def validate(bean: printInfo_result): Unit = {
            ...
            class printInfo extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.PrintService, printInfo_args, printInfo_result]("printInfo", new PrintInfo_argsSerializer(), new PrintInfo_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.PrintService, args: printInfo_args):printInfo_result = {
      ...
      override def validate(bean: printInfo2_result): Unit = {
            ...
            class printInfo2 extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.PrintService, printInfo2_args, printInfo2_result]("printInfo2", new PrintInfo2_argsSerializer(), new PrintInfo2_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.PrintService, args: printInfo2_args):printInfo2_result = {
      ...
      override def validate(bean: printInfo3_result): Unit = {
            ...
            class printInfo3 extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.PrintService, printInfo3_args, printInfo3_result]("printInfo3", new PrintInfo3_argsSerializer(), new PrintInfo3_resultSerializer()){
  ...
  class getServiceMetadata extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.PrintService, getServiceMetadata_args, getServiceMetadata_result](
  "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {
      ...
      class Processor(iface: com.isuwang.soa.scala.service.PrintService) extends
        SoaServiceDefinition(iface,classOf[com.isuwang.soa.scala.service.PrintService], Processor.getProcessMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.isuwang.soa.scala.service.PrintService, _, _]
