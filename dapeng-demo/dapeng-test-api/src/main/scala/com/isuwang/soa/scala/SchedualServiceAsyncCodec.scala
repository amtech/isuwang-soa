...
import com.isuwang.soa.scala.info.serializer._;
      ...
      override def validate(bean: test_result): Unit = {
            ...
            class test extends SoaFunctionDefinition.Async[com.isuwang.soa.scala.service.SchedualServiceAsync, test_args, test_result]("test", new Test_argsSerializer(), new Test_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.SchedualServiceAsync, args: test_args):Future[test_result] = {

              val _result = iface.test(50000).asInstanceOf[CompletableFuture[String]]
              _result.thenApply(Void =>{
                  val res = new SchedualServiceAsyncCodec.test();
              }).get()
        ...
        class getServiceMetadata extends SoaFunctionDefinition.Async[com.isuwang.soa.scala.service.SchedualServiceAsync, getServiceMetadata_args, getServiceMetadata_result](
        "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


          @throws[TException]
          override def apply(iface: com.isuwang.soa.scala.service.SchedualServiceAsync, args: getServiceMetadata_args): getServiceMetadata_result = {

            val source = scala.io.Source.fromInputStream(SchedualServiceAsyncCodec.getClass.getClassLoader.getResourceAsStream("com.isuwang.soa.service.SchedualService.xml"))
        ...
        class Processor(iface: com.isuwang.soa.scala.service.SchedualServiceAsync) extends
        SoaServiceDefinition(iface,classOf[com.isuwang.soa.scala.service.SchedualServiceAsync], Processor.buildMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.isuwang.soa.scala.service.SchedualServiceAsync, _, _]
