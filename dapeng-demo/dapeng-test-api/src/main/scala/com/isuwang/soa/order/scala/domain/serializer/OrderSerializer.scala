 package com.isuwang.soa.order.scala.domain.serializer;
      ...
      while (schemeField == null || schemeField.`type` != com.isuwang.org.apache.thrift.protocol.TType.STOP) {
        ...
        schemeField.id match {
              ...
              case 2 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRING => order_no = iprot.readString
                    case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
            }
              ...
              case 4 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.DOUBLE => amount = iprot.readDouble
                    case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
            }
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("Order"))
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("order_no", com.isuwang.org.apache.thrift.protocol.TType.STRING, 2.asInstanceOf[Short]))
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("amount", com.isuwang.org.apache.thrift.protocol.TType.DOUBLE, 4.asInstanceOf[Short]))
