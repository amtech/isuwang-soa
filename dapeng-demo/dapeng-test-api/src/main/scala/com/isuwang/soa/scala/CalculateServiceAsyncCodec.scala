...
import com.isuwang.soa.scala.info.serializer._;
        ...
        schemeField.id match {
              ...
              case 1 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRING => filename = iprot.readString
                    case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
            }
            
              case 2 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRING => word = iprot.readString
                    case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
            }
      ...
      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordCount_args"))

      
            {
            val elem0 = bean.filename 
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("filename", com.isuwang.org.apache.thrift.protocol.TType.STRING, 1.asInstanceOf[Short]))
            ...
            {
            val elem1 = bean.word 
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("word", com.isuwang.org.apache.thrift.protocol.TType.STRING, 2.asInstanceOf[Short]))
      ...
      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordCount_result"))
      ...
      override def validate(bean: calcualteWordCount_result): Unit = {
            ...
            class calcualteWordCount extends SoaFunctionDefinition.Async[com.isuwang.soa.scala.service.CalculateServiceAsync, calcualteWordCount_args, calcualteWordCount_result]("calcualteWordCount", new CalcualteWordCount_argsSerializer(), new CalcualteWordCount_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.CalculateServiceAsync, args: calcualteWordCount_args):Future[calcualteWordCount_result] = {
              ...
              _result.thenApply(Void =>{
                  val res = new CalculateServiceAsyncCodec.calcualteWordCount();
              }).get()
      ...
      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordsCount_args"))
            ...
            override def read(iprot: TProtocol): calcualteWordsCount_result = {
              ...
              while (schemeField == null || schemeField.`type` != com.isuwang.org.apache.thrift.protocol.TType.STOP) {
                ...
                schemeField.id match {
                  case 0 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.MAP =>  success = {
        val _map0 : com.isuwang.org.apache.thrift.protocol.TMap = iprot.readMapBegin
      ...
      validate(bean)
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordsCount_result"))

      
            {
            val elem0 = bean.success 
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("success", com.isuwang.org.apache.thrift.protocol.TType.MAP, 0.asInstanceOf[Short]))
            
        oprot.writeMapBegin(new com.isuwang.org.apache.thrift.protocol.TMap(com.isuwang.org.apache.thrift.protocol.TType.STRING, com.isuwang.org.apache.thrift.protocol.TType.I32, elem0.size))
      ...
      override def validate(bean: calcualteWordsCount_result): Unit = {
            ...
            class calcualteWordsCount extends SoaFunctionDefinition.Async[com.isuwang.soa.scala.service.CalculateServiceAsync, calcualteWordsCount_args, calcualteWordsCount_result]("calcualteWordsCount", new CalcualteWordsCount_argsSerializer(), new CalcualteWordsCount_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.CalculateServiceAsync, args: calcualteWordsCount_args):Future[calcualteWordsCount_result] = {

              val _result = iface.calcualteWordsCount(args.fileName,50000).asInstanceOf[CompletableFuture[Map[String, Int]]]
              _result.thenApply(Void =>{
                  val res = new CalculateServiceAsyncCodec.calcualteWordsCount();
              }).get()
        ...
        class getServiceMetadata extends SoaFunctionDefinition.Async[com.isuwang.soa.scala.service.CalculateServiceAsync, getServiceMetadata_args, getServiceMetadata_result](
        "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {


          @throws[TException]
          override def apply(iface: com.isuwang.soa.scala.service.CalculateServiceAsync, args: getServiceMetadata_args): getServiceMetadata_result = {

            val source = scala.io.Source.fromInputStream(CalculateServiceAsyncCodec.getClass.getClassLoader.getResourceAsStream("com.isuwang.soa.service.CalculateService.xml"))
        ...
        class Processor(iface: com.isuwang.soa.scala.service.CalculateServiceAsync) extends
        SoaServiceDefinition(iface,classOf[com.isuwang.soa.scala.service.CalculateServiceAsync], Processor.buildMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.isuwang.soa.scala.service.CalculateServiceAsync, _, _]
