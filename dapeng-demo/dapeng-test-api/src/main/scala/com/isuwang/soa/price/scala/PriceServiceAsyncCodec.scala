package com.isuwang.soa.price.scala
        ...
        schemeField.id match {
              ...
              case 1 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRUCT => price = 
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("insertPrice_args"))
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("price", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, 1.asInstanceOf[Short]))
      ...
      override def validate(bean: insertPrice_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.price.scala.service.PriceServiceAsync, args: insertPrice_args):Future[insertPrice_result] = {
              ...
              val _result = iface.insertPrice(args.price,50000)
                ...
                _result.map(i => insertPrice_result()).toJava.toCompletableFuture
      ...
      override def validate(bean: getPrices_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.price.scala.service.PriceServiceAsync, args: getPrices_args):Future[getPrices_result] = {
              ...
              _result.map(getPrices_result(_)).toJava.toCompletableFuture
