...
class SettleSerializer extends BeanSerializer[com.isuwang.soa.settle.scala.domain.Settle] {
  ...
  override def read(iprot: TProtocol): com.isuwang.soa.settle.scala.domain.Settle = {
    ...
    while (schemeField == null || schemeField.`type` != com.isuwang.org.apache.thrift.protocol.TType.STOP) {
      ...
      schemeField.id match {
        ...
        case 3 =>
          schemeField.`type` match {
            case com.isuwang.org.apache.thrift.protocol.TType.DOUBLE => cash_debit = iprot.readDouble
            case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
          }

        case 4 =>
          schemeField.`type` match {
            case com.isuwang.org.apache.thrift.protocol.TType.DOUBLE => cash_credit = iprot.readDouble
            case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
          }

        case 5 =>
          schemeField.`type` match {
            case com.isuwang.org.apache.thrift.protocol.TType.STRING => remark = Option(iprot.readString)
            case _ => com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.`type`)
          }
  ...
  override def write(bean: com.isuwang.soa.settle.scala.domain.Settle, oprot: TProtocol): Unit = {
    ...
    }
    {
      ...
      oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("orderId", com.isuwang.org.apache.thrift.protocol.TType.I32, 2.asInstanceOf[Short]))
    ...
    }
    {
      ...
      oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("cash_debit", com.isuwang.org.apache.thrift.protocol.TType.DOUBLE, 3.asInstanceOf[Short]))
    ...
    }
    {
      ...
      oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("cash_credit", com.isuwang.org.apache.thrift.protocol.TType.DOUBLE, 4.asInstanceOf[Short]))
    ...
    if (bean.remark.isDefined) {
      ...
      oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("remark", com.isuwang.org.apache.thrift.protocol.TType.STRING, 5.asInstanceOf[Short]))
