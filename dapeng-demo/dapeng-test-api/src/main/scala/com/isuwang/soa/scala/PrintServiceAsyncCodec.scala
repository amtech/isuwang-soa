...
import com.isuwang.soa.scala.info.serializer._;
      ...
      override def validate(bean: printInfo_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.scala.service.PrintServiceAsync, args: printInfo_args):Future[printInfo_result] = {
              ...
              _result.thenApply(printInfo_result(_))
      ...
      override def validate(bean: printInfo2_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.scala.service.PrintServiceAsync, args: printInfo2_args):Future[printInfo2_result] = {
              ...
              _result.thenApply(printInfo2_result(_))
      ...
      override def validate(bean: printInfo3_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.scala.service.PrintServiceAsync, args: printInfo3_args):Future[printInfo3_result] = {
              ...
              val _result = iface.printInfo3(50000).asInstanceOf[CompletableFuture[String]]
              _result.thenApply(printInfo3_result(_))
        ...
        "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {
          ...
          @throws[TException]
          override def apply(iface: com.isuwang.soa.scala.service.PrintServiceAsync, args: getServiceMetadata_args): Future[getServiceMetadata_result] = {

            val result = scala.concurrent.Future {
            val source = scala.io.Source.fromInputStream(PrintServiceCodec.getClass.getClassLoader.getResourceAsStream("com.lbb.hello.service.HelloService.xml"))
