package com.isuwang.soa.order.scala
        ...
        schemeField.id match {
              ...
              case 1 =>
                  schemeField.`type` match {
                    case com.isuwang.org.apache.thrift.protocol.TType.STRUCT => order = 
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("createOrder_args"))
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("order", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, 1.asInstanceOf[Short]))
      ...
      override def validate(bean: createOrder_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.order.scala.service.OrderServiceAsync, args: createOrder_args):Future[createOrder_result] = {
              ...
              val _result = iface.createOrder(args.order,50000)
                ...
                _result.map(i => createOrder_result()).toJava.toCompletableFuture
      ...
      override def validate(bean: getOrderById_result): Unit = {
            ...
            def apply(iface: com.isuwang.soa.order.scala.service.OrderServiceAsync, args: getOrderById_args):Future[getOrderById_result] = {
              ...
              _result.map(getOrderById_result(_)).toJava.toCompletableFuture
