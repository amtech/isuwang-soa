...
import com.isuwang.soa.scala.info.serializer._;
      ...
      override def validate(bean: calcualteWordCount_result): Unit = {
            ...
            class calcualteWordCount extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.CalculateService, calcualteWordCount_args, calcualteWordCount_result]("calcualteWordCount", new CalcualteWordCount_argsSerializer(), new CalcualteWordCount_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.CalculateService, args: calcualteWordCount_args):calcualteWordCount_result = {
      ...
      override def validate(bean: calcualteWordsCount_result): Unit = {
            ...
            class calcualteWordsCount extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.CalculateService, calcualteWordsCount_args, calcualteWordsCount_result]("calcualteWordsCount", new CalcualteWordsCount_argsSerializer(), new CalcualteWordsCount_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.CalculateService, args: calcualteWordsCount_args):calcualteWordsCount_result = {
  ...
  class getServiceMetadata extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.CalculateService, getServiceMetadata_args, getServiceMetadata_result](
  "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {
      ...
      class Processor(iface: com.isuwang.soa.scala.service.CalculateService) extends
        SoaServiceDefinition(iface,classOf[com.isuwang.soa.scala.service.CalculateService], Processor.getProcessMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.isuwang.soa.scala.service.CalculateService, _, _]
