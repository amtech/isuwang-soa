...
import com.isuwang.soa.scala.info.serializer._;
      ...
      override def validate(bean: test_result): Unit = {
            ...
            class test extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.SchedualService, test_args, test_result]("test", new Test_argsSerializer(), new Test_resultSerializer()){

            @throws[TException]
            def apply(iface: com.isuwang.soa.scala.service.SchedualService, args: test_args):test_result = {

              val _result = iface.test()
              test_result(_result )
            }
          }
  ...
  class getServiceMetadata extends SoaFunctionDefinition.Sync[com.isuwang.soa.scala.service.SchedualService, getServiceMetadata_args, getServiceMetadata_result](
  "getServiceMetadata", new GetServiceMetadata_argsSerializer(), new GetServiceMetadata_resultSerializer()) {
      ...
      class Processor(iface: com.isuwang.soa.scala.service.SchedualService) extends
        SoaServiceDefinition(iface,classOf[com.isuwang.soa.scala.service.SchedualService], Processor.getProcessMap)

        object Processor{

          type PF = SoaFunctionDefinition[com.isuwang.soa.scala.service.SchedualService, _, _]
