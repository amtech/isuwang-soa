...
public class Settle {
    ...
    public Settle orderId(int orderId) {
        this.orderId = orderId;
        return this;
    }
    ...
    public Settle cash_debit(double cash_debit) {
        this.cash_debit = cash_debit;
        return this;
    }
    ...
    public Settle cash_credit(double cash_credit) {
        this.cash_credit = cash_credit;
        return this;
    }
    ...
    public Settle remark(Optional<String> remark) {
        this.remark = remark;
        return this;
    }
