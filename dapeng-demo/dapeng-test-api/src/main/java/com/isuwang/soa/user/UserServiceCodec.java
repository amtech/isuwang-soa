...
public class UserServiceCodec {
    ...
    public static class CreateUser_argsSerializer implements BeanSerializer<createUser_args> {
        ...
        public void write(createUser_args bean, TProtocol oprot) throws TException {
            ...
            validate(bean);
            oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("createUser_args"));


            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("user", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, (short) 1));
        ...
        @Override
        public String toString(createUser_args bean) {
    ...
    public static class CreateUser_resultSerializer implements BeanSerializer<createUser_result> {
        ...
        public void write(createUser_result bean, TProtocol oprot) throws TException {
            ...
            validate(bean);
            oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("createUser_result"));
        ...
        @Override
        public String toString(createUser_result bean) {
            return bean == null ? "null" : bean.toString();
        }
    }

    public static class createUser<I extends com.isuwang.soa.user.service.UserService> extends SoaFunctionDefinition.Sync<I, createUser_args, createUser_result> {
        public createUser() {
            super("createUser", new CreateUser_argsSerializer(), new CreateUser_resultSerializer());
        }

        @Override
        public createUser_result apply(I iface, createUser_args createUser_args) throws SoaException {

            createUser_result result = new createUser_result();


            iface.createUser(createUser_args.user);
    ...
    public static class GetUserById_argsSerializer implements BeanSerializer<getUserById_args> {
        ...
        public void write(getUserById_args bean, TProtocol oprot) throws TException {
            ...
            validate(bean);
            oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("getUserById_args"));


            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("userId", com.isuwang.org.apache.thrift.protocol.TType.I32, (short) 1));
        ...
        @Override
        public String toString(getUserById_args bean) {
            return bean == null ? "null" : bean.toString();
        }
    ...
    public static class GetUserById_resultSerializer implements BeanSerializer<getUserById_result> {
        ...
        public void write(getUserById_result bean, TProtocol oprot) throws TException {
            ...
            validate(bean);
            oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("getUserById_result"));
        ...
        @Override
        public String toString(getUserById_result bean) {
            return bean == null ? "null" : bean.toString();
        }
    }

    public static class getUserById<I extends com.isuwang.soa.user.service.UserService> extends SoaFunctionDefinition.Sync<I, getUserById_args, getUserById_result> {
        public getUserById() {
            super("getUserById", new GetUserById_argsSerializer(), new GetUserById_resultSerializer());
        }

        @Override
        public getUserById_result apply(I iface, getUserById_args getUserById_args) throws SoaException {

            getUserById_result result = new getUserById_result();


            result.success = iface.getUserById(getUserById_args.userId);
    ...
    public static class getServiceMetadata<I extends com.isuwang.soa.user.service.UserService> extends SoaFunctionDefinition.Sync<I, getServiceMetadata_args, getServiceMetadata_result> {
    ...
    public static class Processor<I extends com.isuwang.soa.user.service.UserService> extends SoaServiceDefinition<com.isuwang.soa.user.service.UserService> {

        public Processor(com.isuwang.soa.user.service.UserService iface, Class<com.isuwang.soa.user.service.UserService> ifaceClass) {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
        }

        @SuppressWarnings("unchecked")
        private static <I extends com.isuwang.soa.user.service.UserService> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap) {
