package com.isuwang.soa;
        ...
        *  @generated
        **/
        public class SchedualServiceCodec {
      ...
      public void validate(test_result bean) throws TException{
            ...
            public static class test<I extends com.isuwang.soa.service.SchedualService> extends SoaFunctionDefinition.Sync<I, test_args, test_result>
            {
              public test()
              {
        ...
        public static class Processor<I extends com.isuwang.soa.service.SchedualService> extends SoaServiceDefinition<com.isuwang.soa.service.SchedualService>
        {

          public Processor(com.isuwang.soa.service.SchedualService iface, Class<com.isuwang.soa.service.SchedualService> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.isuwang.soa.service.SchedualService> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
