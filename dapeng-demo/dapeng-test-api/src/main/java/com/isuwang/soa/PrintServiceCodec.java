package com.isuwang.soa;
      ...
      public void validate(print_result bean) throws TException{
            ...
            public static class print<I extends com.isuwang.soa.service.PrintService> extends SoaFunctionDefinition.Sync<I, print_args, print_result>
            {
              public print()
              {
            ...
            public static class printInfo_args {
                ...
                private com.isuwang.soa.info.Info info;
                public com.isuwang.soa.info.Info getInfo(){
                return this.info;
              }
                public void setInfo(com.isuwang.soa.info.Info info){
                this.info = info;
              }
      ...
      while(true){
        ...
        switch(schemeField.id){
              ...
              com.isuwang.soa.info.Info elem0 = new com.isuwang.soa.info.Info();
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("printInfo_args"));
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("info", com.isuwang.org.apache.thrift.protocol.TType.STRUCT, (short) 1));
            com.isuwang.soa.info.Info elem0 = bean.getInfo();
      ...
      public void validate(printInfo_result bean) throws TException{
            ...
            public static class printInfo<I extends com.isuwang.soa.service.PrintService> extends SoaFunctionDefinition.Sync<I, printInfo_args, printInfo_result>
            {
              public printInfo()
              {
      ...
      public void validate(printInfo2_result bean) throws TException{
            ...
            public static class printInfo2<I extends com.isuwang.soa.service.PrintService> extends SoaFunctionDefinition.Sync<I, printInfo2_args, printInfo2_result>
            {
              public printInfo2()
              {
            ...
            public static class printInfo3_args {
                ...
                private com.isuwang.soa.account.enums.AccountType accountType;
                public com.isuwang.soa.account.enums.AccountType getAccountType(){
                return this.accountType;
              }
                public void setAccountType(com.isuwang.soa.account.enums.AccountType accountType){
      ...
      while(true){
        ...
        switch(schemeField.id){
              ...
              com.isuwang.soa.account.enums.AccountType elem0 = com.isuwang.soa.account.enums.AccountType.findByValue(iprot.readI32());
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("printInfo3_args"));
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("accountType", com.isuwang.org.apache.thrift.protocol.TType.I32, (short) 1));
            com.isuwang.soa.account.enums.AccountType elem0 = bean.getAccountType();
      ...
      public void validate(printInfo3_result bean) throws TException{
            ...
            public static class printInfo3<I extends com.isuwang.soa.service.PrintService> extends SoaFunctionDefinition.Sync<I, printInfo3_args, printInfo3_result>
            {
              public printInfo3()
              {
        ...
        public static class getServiceMetadata<I extends com.isuwang.soa.service.PrintService> extends SoaFunctionDefinition.Sync<I, getServiceMetadata_args, getServiceMetadata_result> {
          ...
          public getServiceMetadata_result apply(I iface, getServiceMetadata_args args) {
            ...
            try (InputStreamReader isr = new InputStreamReader(PrintServiceCodec.class.getClassLoader().getResourceAsStream("com.isuwang.soa.service.PrintService.xml"));
        ...
        public static class Processor<I extends com.isuwang.soa.service.PrintService> extends SoaServiceDefinition<com.isuwang.soa.service.PrintService>
        {

          public Processor(com.isuwang.soa.service.PrintService iface, Class<com.isuwang.soa.service.PrintService> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.isuwang.soa.service.PrintService> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
