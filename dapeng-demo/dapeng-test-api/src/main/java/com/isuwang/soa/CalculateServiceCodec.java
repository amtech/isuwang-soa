package com.isuwang.soa;
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordCount_args"));
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("filename", com.isuwang.org.apache.thrift.protocol.TType.STRING, (short) 1));
            String elem0 = bean.getFilename();
            oprot.writeString(elem0);
            
            oprot.writeFieldEnd();
          
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("word", com.isuwang.org.apache.thrift.protocol.TType.STRING, (short) 2));
      ...
      public void validate(calcualteWordCount_result bean) throws TException{
            ...
            public static class calcualteWordCount<I extends com.isuwang.soa.service.CalculateService> extends SoaFunctionDefinition.Sync<I, calcualteWordCount_args, calcualteWordCount_result>
            {
      ...
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("calcualteWordsCount_result"));
            ...
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("success", com.isuwang.org.apache.thrift.protocol.TType.MAP, (short) 0));
      ...
      public void validate(calcualteWordsCount_result bean) throws TException{
            ...
            public static class calcualteWordsCount<I extends com.isuwang.soa.service.CalculateService> extends SoaFunctionDefinition.Sync<I, calcualteWordsCount_args, calcualteWordsCount_result>
            {
        ...
        public static class Processor<I extends com.isuwang.soa.service.CalculateService> extends SoaServiceDefinition<com.isuwang.soa.service.CalculateService>
        {

          public Processor(com.isuwang.soa.service.CalculateService iface, Class<com.isuwang.soa.service.CalculateService> ifaceClass)
          {
            super(iface, ifaceClass, buildMap(new java.util.HashMap<>()));
          }

          @SuppressWarnings("unchecked")
          private static <I extends com.isuwang.soa.service.CalculateService> java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> buildMap(java.util.Map<String, SoaFunctionDefinition<I, ?, ?>> processMap)
          {
