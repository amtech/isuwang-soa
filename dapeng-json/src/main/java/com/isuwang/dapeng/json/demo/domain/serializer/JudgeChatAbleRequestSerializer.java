 package com.isuwang.dapeng.json.demo.domain.serializer;
        ...
        *  @generated
        **/
        public class JudgeChatAbleRequestSerializer implements BeanSerializer<com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest>{
        
      @Override
      public com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest read(TProtocol iprot) throws TException{

      com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest bean = new com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest();
      ...
      @Override
      public void write(com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest bean, TProtocol oprot) throws TException{

      validate(bean);
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("JudgeChatAbleRequest"));
          ...
          if(bean.getOrderId().isPresent()){
              ...
              Integer elem2 = bean.getOrderId().get();
      ...
      public void validate(com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest bean) throws TException{
      
    }
    
        @Override
        public String toString(com.isuwang.dapeng.json.demo.domain.JudgeChatAbleRequest bean)
