 package com.isuwang.dapeng.json.demo.domain.serializer;
        ...
        *  @generated
        **/
        public class ListAppointmentCalendarRequestSerializer implements BeanSerializer<com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest>{
        
      @Override
      public com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest read(TProtocol iprot) throws TException{

      com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest bean = new com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest();
      ...
      @Override
      public void write(com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest bean, TProtocol oprot) throws TException{

      validate(bean);
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("ListAppointmentCalendarRequest"));
      ...
      public void validate(com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest bean) throws TException{
        ...
        @Override
        public String toString(com.isuwang.dapeng.json.demo.domain.ListAppointmentCalendarRequest bean)
