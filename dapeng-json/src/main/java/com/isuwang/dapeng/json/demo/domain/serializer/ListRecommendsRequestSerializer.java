 package com.isuwang.dapeng.json.demo.domain.serializer;
        ...
        *  @generated
        **/
        public class ListRecommendsRequestSerializer implements BeanSerializer<com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest>{
        
      @Override
      public com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest read(TProtocol iprot) throws TException{

      com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest bean = new com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest();
      ...
      while(true){
       ...
       bean.setRecommendType(Optional.of(elem0));
            }else{
              com.isuwang.org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
              break;
      ...
      @Override
      public void write(com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest bean, TProtocol oprot) throws TException{

      validate(bean);
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("ListRecommendsRequest"));
      ...
      if(bean.getPageRequest().isPresent()){
            ...
            oprot.writeFieldEnd();
          if(bean.getRecommendType().isPresent()){
              ...
              com.isuwang.dapeng.json.demo.enums.RecommendTypeEnum elem3 = bean.getRecommendType().get();
      ...
      public void validate(com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest bean) throws TException{
        ...
        @Override
        public String toString(com.isuwang.dapeng.json.demo.domain.ListRecommendsRequest bean)
