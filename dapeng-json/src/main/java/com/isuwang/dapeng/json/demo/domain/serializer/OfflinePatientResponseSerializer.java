 package com.isuwang.dapeng.json.demo.domain.serializer;
        ...
        *  @generated
        **/
        public class OfflinePatientResponseSerializer implements BeanSerializer<com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse>{
        
      @Override
      public com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse read(TProtocol iprot) throws TException{

      com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse bean = new com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse();
      ...
      @Override
      public void write(com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse bean, TProtocol oprot) throws TException{

      validate(bean);
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("OfflinePatientResponse"));
            ...
            String elem2 = bean.getPhone();
            oprot.writeString(elem2);
            
            oprot.writeFieldEnd();
          
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("gender", com.isuwang.org.apache.thrift.protocol.TType.I32, (short) 4));
            com.isuwang.dapeng.json.demo.enums.Gender elem3 = bean.getGender();
            oprot.writeI32(elem3.getValue());
            
            oprot.writeFieldEnd();
          
            oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("age", com.isuwang.org.apache.thrift.protocol.TType.I32, (short) 5));
            Integer elem4 = bean.getAge();
      ...
      public void validate(com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse bean) throws TException{
        ...
        @Override
        public String toString(com.isuwang.dapeng.json.demo.domain.OfflinePatientResponse bean)
