 package com.isuwang.dapeng.json.demo.domain.serializer;
        ...
        *  @generated
        **/
        public class ListExperienceCouponRequestSerializer implements BeanSerializer<com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest>{
        
      @Override
      public com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest read(TProtocol iprot) throws TException{

      com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest bean = new com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest();
      ...
      @Override
      public void write(com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest bean, TProtocol oprot) throws TException{

      validate(bean);
      oprot.writeStructBegin(new com.isuwang.org.apache.thrift.protocol.TStruct("ListExperienceCouponRequest"));
      ...
      if(bean.getPageRequest().isPresent()){
            ...
            if(bean.getStatus().isPresent()){
              oprot.writeFieldBegin(new com.isuwang.org.apache.thrift.protocol.TField("status", com.isuwang.org.apache.thrift.protocol.TType.I32, (short) 2));
              com.isuwang.dapeng.json.demo.enums.TCouponStatus elem1 = bean.getStatus().get();
      ...
      public void validate(com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest bean) throws TException{
        ...
        @Override
        public String toString(com.isuwang.dapeng.json.demo.domain.ListExperienceCouponRequest bean)
